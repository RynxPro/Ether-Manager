  ...
  return (
    ...
    >
        ...
        <div className="relative h-44 w-full shrink-0 overflow-hidden bg-background">
          ...
          <div className="absolute top-4 left-4 flex items-center gap-2 z-10">
            ...
            {gbData?.hasUpdate ? (
              ...
              <div className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-green-500/10 text-green-500 border border-green-500/20 text-[9px] font-black uppercase tracking-widest backdrop-blur-md shadow-[0_0_15px_rgba(74,222,128,0.1)]">
      ...
      <div className="p-5 flex flex-col flex-1 bg-surface min-h-36 relative z-10">
        ...
        {/* Action Bar */}
        <div
          className="flex items-center justify-between mt-auto pt-4 border-t border-border relative z-10"
        ...
        >
            ...
            <label className="flex items-center cursor-pointer relative group/toggle">
              ...
              <span
                className={cn(
                  ...
                  mod.isEnabled ? "text-text-primary" : "text-text-muted",
                )}
              >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Open Folder"
              className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/0 text-text-muted hover:text-text-primary hover:bg-white/5 transition-all hover:scale-110 active:scale-95"
            >
              <FolderOpen size={16} />
            </button>
          </div>
