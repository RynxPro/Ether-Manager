      ...
      {isLoading || !detail ? (
        ...
        <div className="space-y-6">
          ...
          {sanitizedDescription && (
            <div
              // Third-party HTML: real GameBanana descriptions ship <pre> blocks, wide tables
              // and full-size images that otherwise push the whole window sideways. Anything
              // too wide scrolls inside itself instead of overflowing the page.
              className="max-w-3xl overflow-x-hidden text-sm break-words text-foreground [&_img]:h-auto [&_img]:max-w-full [&_pre]:overflow-x-auto [&_table]:block [&_table]:overflow-x-auto"
