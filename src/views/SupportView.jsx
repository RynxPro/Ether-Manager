        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="flex flex-col items-center text-center justify-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              >
                Thank you for using{" "}
                <span className="text-primary">Aether Manager!</span>
              </motion.h2>
              ...
              >
                <p>
                  Building Aether Manager has been a labor of love, fueled by a
                  passion for gaming and the incredible modding community. My
                  goal has always been to provide the smoothest, most beautiful
                  experience for managing your favorite mods.
                </p>
                <p>
                  If this app has brought joy to your gaming sessions and you'd
                  like to show some love, you can support its continuous
                  development by grabbing me a coffee! It helps keep the
                  creative energy flowing and motivates me to keep adding
